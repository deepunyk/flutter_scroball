...
import dev.dsi.flutter_scroball.ui.MainActivity;
import dev.dsi.flutter_scroball.ui.SplashScreen;
...
public class ScrobbleNotificationManager {
  ...
  private final Map<dev.dsi.flutter_scroball.Track, Integer> playCounts = new HashMap<>();
  ...
  public void updateNowPlaying(dev.dsi.flutter_scroball.Track track) {
    ...
    if (scroballDB.isLoved(track)) {
      ...
      Intent loveIntent = new Intent(context, dev.dsi.flutter_scroball.LoveTrackService.class);
      loveIntent.putExtra(dev.dsi.flutter_scroball.LoveTrackService.ARTIST_KEY, track.artist());
      loveIntent.putExtra(dev.dsi.flutter_scroball.LoveTrackService.TRACK_KEY, track.track());
  ...
  public void notifyScrobbled(dev.dsi.flutter_scroball.Track track, int count) {
    ...
    for (dev.dsi.flutter_scroball.Track t : playCounts.keySet()) {
      String plays = "";
