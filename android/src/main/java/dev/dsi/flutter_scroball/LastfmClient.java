...
public class LastfmClient {
   ...
   * @param callback callback which will be called with an {@link dev.dsi.flutter_scroball.AuthResult} as the message
   *     payload.
   */
  public void getSession(String token, Handler.Callback callback) {
    new GetSessionTask(
            ...
            caller,
            message -> {
              dev.dsi.flutter_scroball.AuthResult result = (dev.dsi.flutter_scroball.AuthResult) message.obj;
   ...
   */
  public void updateNowPlaying(dev.dsi.flutter_scroball.Track track, Handler.Callback callback) {
   ...
   */
  public void scrobbleTracks(List<dev.dsi.flutter_scroball.Scrobble> scrobbles, Handler.Callback callback) {
    ...
    for (int i = 0; i < scrobbles.size(); i++) {
      dev.dsi.flutter_scroball.Scrobble scrobble = scrobbles.get(i);
  ...
  public void getTrackInfo(dev.dsi.flutter_scroball.Track track, Handler.Callback callback) {
   ...
   */
  public void loveTrack(dev.dsi.flutter_scroball.Track track, Handler.Callback callback) {
  ...
  @NonNull
  private ScrobbleData getScrobbleData(dev.dsi.flutter_scroball.Track track, int timestamp) {
  ...
  private static class GetSessionTask extends AsyncTask<String, Void, dev.dsi.flutter_scroball.AuthResult> {
    private final LastfmApi api;
    private final Caller caller;
    ...
    @Override
    protected dev.dsi.flutter_scroball.AuthResult doInBackground(String... params) {
      String token = params[0];

      Session session = api.getSession(token, API_KEY, API_SECRET);
      if (session != null) {
        return dev.dsi.flutter_scroball.AuthResult.builder().sessionKey(session.getKey()).build();
      }

      com.softartdev.lastfm.Result result = caller.getLastResult();
      dev.dsi.flutter_scroball.AuthResult.Builder authResultBuilder = dev.dsi.flutter_scroball.AuthResult.builder();
    ...
    @Override
    protected void onPostExecute(dev.dsi.flutter_scroball.AuthResult authResult) {
  ...
  private static class GetTrackInfoTask
      extends AsyncTask<dev.dsi.flutter_scroball.Track, Object, Track> {
    private final Session session;
    private final Handler.Callback callback;
    private dev.dsi.flutter_scroball.Track track;
    ...
    @Override
    protected Track doInBackground(dev.dsi.flutter_scroball.Track... params) {
      track = params[0];
      try {
    ...
    protected void onPostExecute(Track updatedTrack) {
      ...
      if (updatedTrack != null) {
        dev.dsi.flutter_scroball.Track.Builder builder =
  ...
  private static class LoveTrackTask
      extends AsyncTask<dev.dsi.flutter_scroball.Track, Object, Result> {
    private final LastfmApi api;
    private final Session session;
    private final Handler.Callback callback;
    ...
    @Override
    protected Result doInBackground(dev.dsi.flutter_scroball.Track... params) {
      dev.dsi.flutter_scroball.Track track = params[0];
      try {
