...
public class PlayerState {
  ...
  public void setPlaybackState(PlaybackState playbackState) {
    ...
    if (isPlaying) {
      ...
      postEvent(dev.dsi.flutter_scroball.Track.empty());
  ...
  public void setTrack(dev.dsi.flutter_scroball.Track track) {
    dev.dsi.flutter_scroball.Track currentTrack = null;
  ...
  private void postEvent(dev.dsi.flutter_scroball.Track track) {
    eventBus.post(NowPlayingChangeEvent.builder().track(track).source(player).build());
  }

  @Subscribe
  private void onTrackLoved(dev.dsi.flutter_scroball.TrackLovedEvent e) {
