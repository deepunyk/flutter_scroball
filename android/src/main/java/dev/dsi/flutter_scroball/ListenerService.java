...
public class ListenerService extends NotificationListenerService
  ...
  private dev.dsi.flutter_scroball.PlaybackTracker playbackTracker;
  private SharedPreferences sharedPreferences;

  @Override
  public void onCreate() {
    dev.dsi.flutter_scroball.ScroballApplication application = (dev.dsi.flutter_scroball.ScroballApplication) getApplication();
    ...
    dev.dsi.flutter_scroball.LastfmClient lastfmClient = application.getLastfmClient();
    dev.dsi.flutter_scroball.TrackLover trackLover = new dev.dsi.flutter_scroball.TrackLover(lastfmClient, scroballDB, connectivityManager);
    dev.dsi.flutter_scroball.Scrobbler scrobbler =
        new dev.dsi.flutter_scroball.Scrobbler(
            lastfmClient, scrobbleNotificationManager, scroballDB, connectivityManager, trackLover);

    playbackTracker = new dev.dsi.flutter_scroball.PlaybackTracker(scrobbleNotificationManager, scrobbler);
    ...
    dev.dsi.flutter_scroball.NetworkStateReceiver networkStateReceiver = new dev.dsi.flutter_scroball.NetworkStateReceiver(scrobbler);
